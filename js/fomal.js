...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("20/08/2023 00:00:00");
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ...
      : `<div style="font-size:13px;font-weight:bold">下班啦 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒</div>`),
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://picgo.cylgis.top/picture/cover/2023/12/29/default_cover_5.webp);
